...
- 产品名称统一写作 `SnSworker`，公共概念以[产品概念](docs/architecture/product-concepts.md)为准。
...
SnSworker 当前由 Shanghai Mofan Technology Co., Ltd. 主导维护。社区成员可以通过持续、可靠的贡献逐步获得更多维护权限。

## 外部贡献

SnSworker 的公开源码使用 `AGPL-3.0-only`，同时保留单独商业授权能力。
