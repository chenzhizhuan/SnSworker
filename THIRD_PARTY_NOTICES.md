...
SnSworker 包含第三方软件、字体和资产。它们适用各自许可证；根目录 AGPL-3.0-only 不替代这些条款。本文件是索引，完整条款以仓内许可证文件为准。
...
| Table Engine Canvas / Teable-derived work | Teable, Inc. 与 SnSworker Contributors | MIT | `packages/table-engine-canvas/LICENSE` |
