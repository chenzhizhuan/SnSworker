...
/**
 * Tool execution metadata（SnSworker 扩展，附加到 tool_result.tabtin_metadata）。
 *
...
/**
 * SnSworker source ref snapshot——5 种 ref_kind 嵌套 union（双 discriminator）。
 *
 ...
 * | 17 | tabtin_rich_content | SnSworker | 富内容（10 种 kind） |
 * | 18 | tabtin_composer_preset | SnSworker | composer 模板 |
 * | 19 | tabtin_ask_user_fields | SnSworker | ask_user 回填 |
 * | 20 | tabtin_skill_invocation | SnSworker | skill 注入 |
 * | 21 | tabtin_source_ref | SnSworker | 引用源 |
 * | 22 | tabtin_approval_request | SnSworker | 审批占位 |
 */
...
/**
 * stop_reason 字面量集合（与 Anthropic API 对齐 + SnSworker 扩展）。
 *
