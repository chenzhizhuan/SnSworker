...
/**
 * Build the SnSworker runtime env block injected into shell child processes.
 *
 ...
 * can `Object.keys(...)` to detect "any SnSworker env was injected".
 *
 ...
 * 用户脚本侧 0 外部消费者（SnSworker 未上线），改名无副作用。
 */
