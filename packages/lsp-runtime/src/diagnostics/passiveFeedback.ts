...
/**
 * Map LSP severity to SnSworker diagnostic severity.
 *
...
/**
 * Convert LSP diagnostics to SnSworker's DiagnosticFile format.
 *
 */
      ...
      serverInstance.onNotification(
        ...
        (params: unknown) => {
          ...
          try {
            ...
            // Convert LSP diagnostics to SnSworker format (can throw on invalid URIs)
