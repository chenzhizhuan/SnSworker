 ...
 *
 * 基于生产环境高频对话沉淀的精准 fuzzy 匹配实现。事故 c39cd8b2 复盘发现 SnSworker 旧实现仅 2 级（exact
 ...
 * 部空白合并」风格，SnSworker Wave 1 dogfood 验证过会假阳性命中（calculator
 ...
 *
 * 用于规范化匹配——SnSworker read_file 输出走 cat -n 行号 + tab 前缀 + 文件原
