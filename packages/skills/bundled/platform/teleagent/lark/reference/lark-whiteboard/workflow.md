...
> **Version**: `1.0.0`
> **CLI Help**: `lark-cli whiteboard --help`
...
## 不在本 skill 范围
- 文档内容编辑 → lark-doc [lark-doc](../lark-doc/workflow.md)
- 在文档中创建画板 → [lark-doc-whiteboard.md](../lark-doc/references/lark-doc-whiteboard.md)
- 表格 / Base 操作 → [lark-sheets](../lark-sheets/workflow.md) / [lark-base](../lark-base/workflow.md)
