...
> **Version**: `2.0.0`
> **CLI Help**: `lark-cli docs --api-version v2 --help; lark-cli docs +create --api-version v2 --help; lark-cli docs +fetch --api-version v2 --help; lark-cli docs +update --api-version v2 --help`
...
1. [`../lark-shared/workflow.md`](../lark-shared/workflow.md) — 认证、权限处理、全局参数（所有操作通用）
...
| 标签 / 属性 | 提取字段 | 切到技能 |
|-|-|-|
| `<sheet token="..." sheet-id="...">` | `token` -> spreadsheet_token, `sheet-id` | [`lark-sheets`](../lark-sheets/workflow.md) |
| `<bitable token="..." table-id="...">` | `token` -> app_token, `table-id` | [`lark-base`](../lark-base/workflow.md) |
| `<cite type="doc" file-type="sheets" token="..." sheet-id="...">` | 同 `<sheet>` | [`lark-sheets`](../lark-sheets/workflow.md) |
| `<cite type="doc" file-type="bitable" token="..." table-id="...">` | 同 `<bitable>` | [`lark-base`](../lark-base/workflow.md) |
| `<vc-transcribe-tab vc-node-id="...">` | `vc-node-id` -> note_id | [`lark-note`](../lark-note/workflow.md)：先 `note +detail --note-id <vc-node-id>` |
...
- 文档评论管理 → [`lark-drive`](../lark-drive/workflow.md)
- 电子表格或 Base 的数据操作 → [`lark-sheets`](../lark-sheets/workflow.md) / [`lark-base`](../lark-base/workflow.md)
- 云空间文件上传、下载、权限管理 → [`lark-drive`](../lark-drive/workflow.md)
