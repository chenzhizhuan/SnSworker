...
AIGC:
  ...
  Label: '1'
  ProduceID: '4e6c1440-b6d7-4912-9b53-31dd2b6aba57'
  PropagateID: '4e6c1440-b6d7-4912-9b53-31dd2b6aba57'
  ReservedCode1: '697c91f6-38db-4441-8192-3ed88b0ff816'
  ReservedCode2: '697c91f6-38db-4441-8192-3ed88b0ff816'
---
...
返回中可能含 `<sheet>`、`<bitable>`、`<cite file-type="sheets|bitable">`。内部数据无法通过 `docs +fetch --api-version v2` 获取，提取 `token` 等属性后切到 [`lark-sheets`](../../lark-sheets/workflow.md) / [`lark-base`](../../lark-base/workflow.md) 下钻，详见 [快速决策](../workflow.md) 路由表。
