...
> **Prerequisite:** Read [`../lark-shared/workflow.md`](../../lark-shared/workflow.md) first to understand authentication, global parameters, and safety rules.
...
- [lark-im](../workflow.md) - all message-related commands
- [lark-shared](../../lark-shared/workflow.md) - authentication and global parameters
