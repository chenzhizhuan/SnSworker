...
> **Prerequisites:** Please read `../lark-shared/workflow.md` to understand authentication, global parameters, and security rules.
...
- [lark-task](../workflow.md) -- All task commands
