...
2. For document partial reads, follow [`../../lark-doc/workflow.md`](../../lark-doc/workflow.md) and [`../../lark-doc/references/lark-doc-fetch.md`](../../lark-doc/references/lark-doc-fetch.md).
3. For sheet / bitable down-drill, follow [`../../lark-sheets/workflow.md`](../../lark-sheets/workflow.md) or [`../../lark-base/workflow.md`](../../lark-base/workflow.md) only when title and path are insufficient.
