...
Before running this workflow, MUST read [`../../lark-shared/workflow.md`](../../lark-shared/workflow.md) for identity, authentication, permission handling, and write-operation confirmation rules.

Load other skills / references progressively:

- Wiki / personal library target: [`../../lark-wiki/workflow.md`](../../lark-wiki/workflow.md)
- Content read required: [`../../lark-doc/workflow.md`](../../lark-doc/workflow.md) and [`../../lark-doc/references/lark-doc-fetch.md`](../../lark-doc/references/lark-doc-fetch.md)
- Sheet down-drill required: [`../../lark-sheets/workflow.md`](../../lark-sheets/workflow.md)
- Base down-drill required: [`../../lark-base/workflow.md`](../../lark-base/workflow.md)
...
- [lark-shared](../../lark-shared/workflow.md)
- [lark-drive](../workflow.md)
...
- [lark-wiki](../../lark-wiki/workflow.md)
- [lark-wiki-node-delete](../../lark-wiki/references/lark-wiki-node-delete.md)
- [lark-doc](../../lark-doc/workflow.md)
- [lark-doc-fetch](../../lark-doc/references/lark-doc-fetch.md)
- [lark-sheets](../../lark-sheets/workflow.md)
- [lark-base](../../lark-base/workflow.md)
