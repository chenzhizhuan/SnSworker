...
1. Follow [`../../lark-shared/workflow.md`](../../lark-shared/workflow.md) for identity, auth, and permission handling.
2. For Wiki / personal library targets, follow [`../../lark-wiki/workflow.md`](../../lark-wiki/workflow.md).
