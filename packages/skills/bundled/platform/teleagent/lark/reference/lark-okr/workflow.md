...
- 待办任务管理 → 使用 [`lark-task`](../lark-task/workflow.md)
- 日程安排 → 使用 [`lark-calendar`](../lark-calendar/workflow.md)
- 绩效评估 → 使用 [`lark-openapi-explorer`](../lark-openapi-explorer/workflow.md) 查找原生接口
