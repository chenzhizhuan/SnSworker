 ...
 * CanvasGridAdapter
 *
 * Adapts SnSworker's TableGridRendererProps contract to Teable's Grid component.
...
// ---------------------------------------------------------------------------
// Group extraction: convert SnSworker's flat row array (with __rowType markers)
  ...
  function CanvasGridAdapter(props, ref) {
    ...
    const handleCopy = useCallback(
      (selection: CombinedSelection, e: React.ClipboardEvent) => {
        ...
        // HTML channel: embed raw cell values so paste within SnSworker can
