...
/**
 * ActivityRail 常驻窄栏固定宽度：88px（图标 22px + 下方文字标签 + 两侧 padding）。
 * 2026-09-14：80→88px，配合 label 14px（视觉~12.6px@zoom0.9）容纳 4 字中文不截断。
 * 图标+文字标签垂直排列，一眼可辨菜单项，无需鼠标悬停。
 * 红绿灯避让由 ShellTopBar 横轴承担，窄栏不必拉到 traffic-light 右缘对齐。
 */
export const SHELL_ACTIVITY_RAIL_WIDTH = 88
