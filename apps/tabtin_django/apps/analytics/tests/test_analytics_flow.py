...
class ShortLinkResolveTest(TestCase):
    ...
    def test_latest_release_prefers_website_file_url(self):
        ...
        AppRelease.objects.create(
            ...
            arch="arm64",
            channel="stable",
            file_url="https://cdn.example.com/SnSworker-2.0.0-arm64-mac.zip",
            website_file_url="https://cdn.example.com/SnSworker-2.0.0-arm64.dmg",
            is_draft=False,
            published_at=timezone.now(),
        )
        link = ShortLink.objects.create(
        ...
        self.assertEqual(
            ...
            "https://cdn.example.com/SnSworker-2.0.0-arm64.dmg",
        )
