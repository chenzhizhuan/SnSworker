# Contributing to SnSworker

[中文](CONTRIBUTING.md)

Thank you for your interest in SnSworker. Contributions in Chinese and English are welcome.
...
- Write the product name as `SnSworker` and follow the public [product concepts](docs/architecture/product-concepts.en.md).
...
SnSworker is currently maintained under the leadership of Shanghai Mofan Technology Co., Ltd. Community members may earn broader maintenance responsibility through sustained, reliable contributions.

## External contributions

SnSworker's public source uses `AGPL-3.0-only` while preserving separate commercial licensing options.
